-- Kaldıraçlı işlemler için eksik tabloları ekle
-- Veritabanı: u225998063_yenip

USE u225998063_yenip;
...
-- Kaldıraç sistemi için ayarlar tablosuna değerler ekle
...
SELECT 'Kaldıraçlı işlem tabloları başarıyla oluşturuldu!' as Status;